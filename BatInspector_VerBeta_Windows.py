...
class MainWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Bat Spectrogram Inspector v5 – Phase 2")
    ...
    def _export_video_mapped(self):
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as tdir:
                ...
                # 4) Mux into MOV with ffmpeg bundled by imageio-ffmpeg
                try:
                    from imageio_ffmpeg import get_ffmpeg_exe
                    ffmpeg_exe = get_ffmpeg_exe()
                except Exception as e:
                    QMessageBox.critical(self, "Export Video",
                                         f"Could not locate bundled ffmpeg:\n{e}")
                    return
                ...
                try:
                    ...
                    QMessageBox.critical(self, "Export Video",
                                         ...
                                         "Install ffmpeg or ensure imageio-ffmpeg is available.")
                    return
